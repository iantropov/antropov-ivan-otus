...
Далее **САГ** - это сервис аукционов Горячий
Далее **САХ** - это сервис аукционов Холодный
...
2. АИ инициирует запуск аукциона в СА
3. СА инициализирует новый аукцион
...
3. СА запускает пользователя в СА
...
3. Деньги блокируются на счету в СА
4. СА принимает новую цену сверки
...
3. СА закрывает аукцион (если был победитель, то с него списывается сумма за лот в СК)
4. СА выгражает информацию из памяти в хранилище на диске
5. Участники в КИ и АИ видят информацию о завершившимся аукционе
...
- Сервис кошельков
- Сервис аукционов Горячий (онлайн аукцион)
- Сервис аукционов Холодный (оффлайн данные об аукционе+история)

### ADR (сервис аукционов Горячий)
